...
& $bash -c "bash $script && { bash /d/claude-workspace/platform/openclaw/start.sh; bash /d/claude-workspace/platform/hermes-platform/start.sh; bash /d/claude-workspace/platform/browser-intent/start.sh; }"
